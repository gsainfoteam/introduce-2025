import ToyProjectThumbnail0 from "./assets/examples/0.png";
import ToyProjectThumbnail1 from "./assets/examples/1.png";
import ToyProjectThumbnail2 from "./assets/examples/2.png";
import ToyProjectThumbnail3 from "./assets/examples/3.png";
import ToyProjectThumbnail4 from "./assets/examples/4.png";
...
const toyProjects: ToyProject[] = [
  {
    ...
    thumbnail: ToyProjectThumbnail0,
  },
  {
    id: 1,
    title: {
    ...
    thumbnail: ToyProjectThumbnail1,
  },
  {
    id: 2,
    title: {
    ...
    thumbnail: ToyProjectThumbnail2,
  },
  {
    id: 3,
    title: {
  ...
  },
  {
    ...
    thumbnail: ToyProjectThumbnail4,
  },
];
